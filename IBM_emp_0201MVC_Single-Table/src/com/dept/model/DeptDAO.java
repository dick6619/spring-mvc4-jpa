...
public class DeptDAO implements DeptDAO_interface {
	...
	private static final String GET_Emps_ByDeptno_STMT = "SELECT empno,ename,job,DATE_FORMAT(hiredate,'%Y-%m-%d') hiredate,sal,comm,deptno FROM emp2 where deptno = ? order by empno";
