...
public class EmpDAO implements EmpDAO_interface {
	...
	private static final String GET_ALL_STMT = 
		"SELECT empno,ename,job,DATE_FORMAT(hiredate,'%Y-%m-%d') hiredate,sal,comm,deptno FROM emp2 order by empno";
	private static final String GET_ONE_STMT = 
		"SELECT empno,ename,job,DATE_FORMAT(hiredate,'%Y-%m-%d') hiredate,sal,comm,deptno FROM emp2 where empno = ?";
